        ...
        <div class="d-flex justify-content-center col-12 mt-5">
            <form class="needs-validation" novalidate>
                ...
                <div class="d-flex justify-content-center col-12">
                    <button class="btn btn-primary btn-sm  d-block p-2" type="submit">دخول</button>

                </div>
                <div class="d-flex justify-content-center col-12">
                    <button class="btn btn-primary btn-sm  d-block p-2" type="submit">بوابة الدخول
                        الموحد</button>

                </div>
                <div class="d-flex justify-content-center col-12 ">
                    <button class="btn btn-primary btn-sm d-block p-2" type="submit">مستخدم جديد</button>
